...
bool Instance::chargement_Instance(string s_chemin) 
{
...
float Instance::get_POI_Duree_Max_Voyage(int i_Id_jour) 
{
...
float Instance::get_POI_Coord_X(int i_Id_POI) 
{
    if(v_POI.size()==0)
        return 0.0;
...
float Instance::get_POI_Coord_Y(int i_Id_POI) 
{
    if(v_POI.size()==0)
        return 0.0;
    if((i_Id_POI>=0)&&(i_Id_POI<i_Nombre_POI))
...
int Instance::get_POI_Score(int i_Id_POI) 
{
    if(v_POI.size()==0)
        return 0.0;
    if((i_Id_POI>=0)&&(i_Id_POI<i_Nombre_POI))
...
float Instance::get_POI_Heure_ouverture(int i_Id_POI) 
{
    if(v_POI.size()==0)
        return 0.0;
    if((i_Id_POI>=0)&&(i_Id_POI<i_Nombre_POI))
...
float Instance::get_POI_Heure_fermeture(int i_Id_POI) 
{
    if(v_POI.size()==0)
        return 0.0;
    if((i_Id_POI>=0)&&(i_Id_POI<i_Nombre_POI))
...
float Instance::get_Hotel_Coord_X(int i_Id_Hotel) 
{
    if(v_Hotel.size()==0)
        return 0.0;
...
float Instance::get_Hotel_Coord_Y(int i_Id_Hotel) 
{
    if(v_Hotel.size()==0)
        return 0.0;
    if((i_Id_Hotel>=0)&&(i_Id_Hotel<i_Nombre_Hotel))
...
float Instance::get_distance_Hotel_POI(int i_Id_Hotel ,int i_Id_POI) 
{
    if(v_POI.size()==0)
        return 0.0;
...
float Instance::get_distance_POI_POI(int i_Id_POI1 ,int i_Id_POI2) 
{
    if(v_POI.size()==0)
        return 0.0;
...
float Instance::get_distance_Hotel_Hotel(int i_Id_Hotel1,int i_Id_Hotel2) 
{
    if(v_Hotel.size()==0)
        return 0.0;
...
void Instance::show()
{
    ...
    for (int i = 0; i < v_v_f_distances.size(); ++i){
        cout << "SD" << endl;
        for (int j = 0; j < v_v_f_distances.size(); ++j){
            cout << "PO" << endl;
            cout << "Distances ::: " << v_v_f_distances[i][j] << endl;
        }
    }
}
