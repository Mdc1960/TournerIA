...
class Instance
{
    ...
    /* Instancie les données (écrase les données précédentes), retourne VRAI si chargement correct, FAUX sinon */
        bool chargement_Instance(string s_chemin) ;
    ...
    /* LES Getters */
        ...
        float get_POI_Duree_Max_Voyage(int i_Id_jour) ;
        float get_POI_Coord_X(int i_Id_POI) ;
        float get_POI_Coord_Y(int i_Id_POI) ;
        int get_POI_Score(int i_Id_POI) ;
        float get_POI_Heure_ouverture(int i_Id_POI) ;
        float get_POI_Heure_fermeture(int i_Id_POI) ;
        int get_Id_Hotel_depart(void);
        int get_Id_Hotel_Arrivee(void);
        float get_Hotel_Coord_X(int i_Id_Hotel) ;
        float get_Hotel_Coord_Y(int i_Id_Hotel) ;
        float get_distance_Hotel_POI(int i_Id_Hotel ,int i_Id_POI) ;
        float get_distance_POI_POI(int i_Id_POI1 ,int i_Id_POI2) ;
        float get_distance_Hotel_Hotel(int i_Id_Hotel1,int i_Id_Hotel2) ;
        void show();
